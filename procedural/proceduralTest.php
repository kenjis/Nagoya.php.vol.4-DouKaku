...
class proceduralTest extends PHPUnit_Framework_TestCase
{
    public function testProcessRegister()
    {
        ...
        $test = processRegister($registerQueue, $registerCapability);
        $expected = [
            1 => [],
            2 => [],
            3 => [2],
    ...
    public function testAddToQueue()
    {
        ...
        $item = '1';
        $test = addToQueue($item, $registerQueue);
        $expected = [
            1 => ['1'],
            2 => [],
            3 => [],
    ...
    public function testGetRegisterQueuePersonNumber()
    {
        $registerQueue = [
            1 => [],
            2 => [],
        ...
        $test = getRegisterQueuePersonNumber($registerQueue);
        $expected = [
            1 => 0,
            2 => 0,
            3 => 0,
    ...
    public function testGetMinRegister()
    {
        $registerQueue = [
            1 => [1],
            2 => [2],
        ...
        $test = getMinRegister($registerQueue);
        $expected = 1;
        $this->assertEquals($expected, $test);
    }
